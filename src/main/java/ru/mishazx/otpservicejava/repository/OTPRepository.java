...
public interface OTPRepository extends JpaRepository<OTPCode, Long> {
    ...
    @Modifying
    @Transactional
    @Query("UPDATE OTPCode o SET o.status = ru.mishazx.otpservicejava.model.OTPCode.OtpStatus.EXPIRED WHERE o.status = ru.mishazx.otpservicejava.model.OTPCode.OtpStatus.ACTIVE AND o.expiresAt < :now")
